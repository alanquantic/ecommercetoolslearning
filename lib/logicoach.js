...
export function buildLogiCoachPrompt(state) {
  const evaluation = state.evaluation || evaluateLogiCoach(state.answers);
  const lines = [
  ...
  lines.push(
    ...
    "- No inventes herramientas que no existen; cita Estafeta, FedEx, DHL, 99 Minutos, Uber Direct, Shopify, Tiendanube, WhatsApp Business, Excel y similares cuando aplique.",
